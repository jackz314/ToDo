...
public class SimpleColorPickerDialog extends Dialog {
    ...
    private int mInitialColor;//initial color
     ...
     */
    public SimpleColorPickerDialog(Context context, String title,
     ...
     * @param listener return listener
     */
    public SimpleColorPickerDialog(Context context, int initialColor, String title, OnColorChangedListener listener) {
        super(context);
    ...
    private class ColorPickerView extends View {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    if(downInCircle && inCircle) {//down按在渐变色环内, 且move也在渐变色环内
                        ...
                        if(debug) Log.v(TAG, "In the circle, Coordinates: " + x + "," + y);
                    }else if(downInRect && inRect) {//down在渐变方块内, 且move也在渐变方块内
                        mCenterPaint.setColor(interpRectColor(mRectColors, x));
                    }
                    if(debug) Log.v(TAG, "[MOVE] Highlight: " + highlightCenter + "Lowlight: " + highlightCenterLittle + " 中心: " + inCenter);
        ...
        /**
         * Determine whether coordinate is in the center
         * @param x x coordinate
         * @param y y coordinate
         * @param centerRadius radius of the circe
         * @return
         */
        ...
        /**
         * determine whether coordinate is on changing zone
         * @param x
         * @param y
         * @return
         */
