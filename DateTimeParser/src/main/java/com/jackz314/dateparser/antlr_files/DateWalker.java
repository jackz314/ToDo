// $ANTLR 3.5.2 com/joestelmach/natty/generated/DateWalker.g 2017-01-25 23:39:03
 package com.jackz314.dateparser.antlr_files;

import com.jackz314.dateparser.WalkerState;
...
public class DateWalker extends TreeParser {
	...
	// $ANTLR start "parse"
	// com/joestelmach/natty/generated/DateWalker.g:44:1: parse : date_time_alternative ( recurrence )? ;
	public final void parse() throws RecognitionException {
		try {
			// com/joestelmach/natty/generated/DateWalker.g:45:3: ( date_time_alternative ( recurrence )? )
			// com/joestelmach/natty/generated/DateWalker.g:45:5: date_time_alternative ( recurrence )?
			{
			pushFollow(FOLLOW_date_time_alternative_in_parse51);
			date_time_alternative();
			state._fsp--;

			// com/joestelmach/natty/generated/DateWalker.g:45:27: ( recurrence )?
			int alt1=2;
	...
	// com/joestelmach/natty/generated/DateWalker.g:48:1: recurrence : ^( RECURRENCE ( date_time )? ) ;
	public final void recurrence() throws RecognitionException {
		 
		    _walkerState.setRecurring();
		  
		try {
			// com/joestelmach/natty/generated/DateWalker.g:52:3: ( ^( RECURRENCE ( date_time )? ) )
			// com/joestelmach/natty/generated/DateWalker.g:52:5: ^( RECURRENCE ( date_time )? )
			{
			match(input,RECURRENCE,FOLLOW_RECURRENCE_in_recurrence77); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				// com/joestelmach/natty/generated/DateWalker.g:52:18: ( date_time )?
				int alt2=2;
	...
	// com/joestelmach/natty/generated/DateWalker.g:55:1: date_time_alternative : ^( DATE_TIME_ALTERNATIVE ( date_time )+ ) ;
	public final void date_time_alternative() throws RecognitionException {
		try {
			// com/joestelmach/natty/generated/DateWalker.g:56:3: ( ^( DATE_TIME_ALTERNATIVE ( date_time )+ ) )
			// com/joestelmach/natty/generated/DateWalker.g:56:5: ^( DATE_TIME_ALTERNATIVE ( date_time )+ )
			{
			match(input,DATE_TIME_ALTERNATIVE,FOLLOW_DATE_TIME_ALTERNATIVE_in_date_time_alternative98); 
			match(input, Token.DOWN, null); 
			// com/joestelmach/natty/generated/DateWalker.g:56:29: ( date_time )+
			int cnt3=0;
			loop3:
			while (true) {
				int alt3=2;
	...
	// com/joestelmach/natty/generated/DateWalker.g:59:1: date_time : ^( DATE_TIME ( date )? ( time )? ) ;
	public final void date_time() throws RecognitionException {
		try {
			// com/joestelmach/natty/generated/DateWalker.g:63:3: ( ^( DATE_TIME ( date )? ( time )? ) )
			// com/joestelmach/natty/generated/DateWalker.g:63:5: ^( DATE_TIME ( date )? ( time )? )
			{
			match(input,DATE_TIME,FOLLOW_DATE_TIME_in_date_time123); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				// com/joestelmach/natty/generated/DateWalker.g:63:17: ( date )?
				int alt4=2;
				...
				// com/joestelmach/natty/generated/DateWalker.g:63:23: ( time )?
				int alt5=2;
	...
	// $ANTLR start "date"
	// com/joestelmach/natty/generated/DateWalker.g:66:1: date : ( relative_date | explicit_date );
	public final void date() throws RecognitionException {
		try {
			// com/joestelmach/natty/generated/DateWalker.g:67:3: ( relative_date | explicit_date )
			int alt6=2;
			...
			switch (alt6) {
				case 1 :
					// com/joestelmach/natty/generated/DateWalker.g:67:5: relative_date
					{
					...
					break;
				case 2 :
					// com/joestelmach/natty/generated/DateWalker.g:68:5: explicit_date
					{
	...
	// com/joestelmach/natty/generated/DateWalker.g:71:1: relative_date : ^( RELATIVE_DATE ( seek )* ( explicit_seek )* ) ;
	public final void relative_date() throws RecognitionException {
		try {
			// com/joestelmach/natty/generated/DateWalker.g:72:3: ( ^( RELATIVE_DATE ( seek )* ( explicit_seek )* ) )
			// com/joestelmach/natty/generated/DateWalker.g:72:5: ^( RELATIVE_DATE ( seek )* ( explicit_seek )* )
			{
			match(input,RELATIVE_DATE,FOLLOW_RELATIVE_DATE_in_relative_date170); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				// com/joestelmach/natty/generated/DateWalker.g:72:21: ( seek )*
				loop7:
				while (true) {
					int alt7=2;
				...
				// com/joestelmach/natty/generated/DateWalker.g:72:27: ( explicit_seek )*
				loop8:
				while (true) {
					int alt8=2;
	...
	// com/joestelmach/natty/generated/DateWalker.g:75:1: week_index : ^( WEEK_INDEX index= INT ^( DAY_OF_WEEK day= INT ) ) ;
	public final void week_index() throws RecognitionException {
		CommonTree index=null;
		CommonTree day=null;

		try {
			// com/joestelmach/natty/generated/DateWalker.g:76:3: ( ^( WEEK_INDEX index= INT ^( DAY_OF_WEEK day= INT ) ) )
			// com/joestelmach/natty/generated/DateWalker.g:76:5: ^( WEEK_INDEX index= INT ^( DAY_OF_WEEK day= INT ) )
			{
	...
	// com/joestelmach/natty/generated/DateWalker.g:80:1: explicit_date : ^( EXPLICIT_DATE ^( MONTH_OF_YEAR month= INT ) ^( DAY_OF_MONTH dom= INT ) ( ^( DAY_OF_WEEK dow= INT ) )? ( ^( YEAR_OF year= INT ) )? ) ;
	public final void explicit_date() throws RecognitionException {
		...
		try {
			// com/joestelmach/natty/generated/DateWalker.g:81:3: ( ^( EXPLICIT_DATE ^( MONTH_OF_YEAR month= INT ) ^( DAY_OF_MONTH dom= INT ) ( ^( DAY_OF_WEEK dow= INT ) )? ( ^( YEAR_OF year= INT ) )? ) )
			// com/joestelmach/natty/generated/DateWalker.g:81:5: ^( EXPLICIT_DATE ^( MONTH_OF_YEAR month= INT ) ^( DAY_OF_MONTH dom= INT ) ( ^( DAY_OF_WEEK dow= INT ) )? ( ^( YEAR_OF year= INT ) )? )
			{
			...
			// com/joestelmach/natty/generated/DateWalker.g:82:9: ( ^( DAY_OF_WEEK dow= INT ) )?
			int alt9=2;
			...
			switch (alt9) {
				case 1 :
					// com/joestelmach/natty/generated/DateWalker.g:82:10: ^( DAY_OF_WEEK dow= INT )
					{
			...
			// com/joestelmach/natty/generated/DateWalker.g:82:35: ( ^( YEAR_OF year= INT ) )?
			int alt10=2;
			...
			switch (alt10) {
				case 1 :
					// com/joestelmach/natty/generated/DateWalker.g:82:36: ^( YEAR_OF year= INT )
					{
	...
	// $ANTLR start "time"
	// com/joestelmach/natty/generated/DateWalker.g:86:1: time : ( explicit_time | relative_time );
	public final void time() throws RecognitionException {
		try {
			// com/joestelmach/natty/generated/DateWalker.g:87:3: ( explicit_time | relative_time )
			int alt11=2;
			...
			switch (alt11) {
				case 1 :
					// com/joestelmach/natty/generated/DateWalker.g:87:5: explicit_time
					{
					...
					break;
				case 2 :
					// com/joestelmach/natty/generated/DateWalker.g:88:5: relative_time
					{
	...
	// com/joestelmach/natty/generated/DateWalker.g:91:1: explicit_time : ^( EXPLICIT_TIME ^( HOURS_OF_DAY hours= INT ) ( ^( MINUTES_OF_HOUR minutes= INT ) )? ( ^( SECONDS_OF_MINUTE seconds= INT ) )? ( AM_PM )? (zone= ZONE |zone= ZONE_OFFSET )? ) ;
	public final void explicit_time() throws RecognitionException {
		...
		try {
			// com/joestelmach/natty/generated/DateWalker.g:92:3: ( ^( EXPLICIT_TIME ^( HOURS_OF_DAY hours= INT ) ( ^( MINUTES_OF_HOUR minutes= INT ) )? ( ^( SECONDS_OF_MINUTE seconds= INT ) )? ( AM_PM )? (zone= ZONE |zone= ZONE_OFFSET )? ) )
			// com/joestelmach/natty/generated/DateWalker.g:92:5: ^( EXPLICIT_TIME ^( HOURS_OF_DAY hours= INT ) ( ^( MINUTES_OF_HOUR minutes= INT ) )? ( ^( SECONDS_OF_MINUTE seconds= INT ) )? ( AM_PM )? (zone= ZONE |zone= ZONE_OFFSET )? )
			{
			...
			// com/joestelmach/natty/generated/DateWalker.g:92:47: ( ^( MINUTES_OF_HOUR minutes= INT ) )?
			int alt12=2;
			...
			switch (alt12) {
				case 1 :
					// com/joestelmach/natty/generated/DateWalker.g:92:48: ^( MINUTES_OF_HOUR minutes= INT )
					{
			...
			// com/joestelmach/natty/generated/DateWalker.g:93:9: ( ^( SECONDS_OF_MINUTE seconds= INT ) )?
			int alt13=2;
			...
			switch (alt13) {
				case 1 :
					// com/joestelmach/natty/generated/DateWalker.g:93:10: ^( SECONDS_OF_MINUTE seconds= INT )
					{
			...
			// com/joestelmach/natty/generated/DateWalker.g:93:45: ( AM_PM )?
			int alt14=2;
			...
			// com/joestelmach/natty/generated/DateWalker.g:93:52: (zone= ZONE |zone= ZONE_OFFSET )?
			int alt15=3;
			...
			switch (alt15) {
				case 1 :
					// com/joestelmach/natty/generated/DateWalker.g:93:53: zone= ZONE
					{
					zone=(CommonTree)match(input,ZONE,FOLLOW_ZONE_in_explicit_time365); 
					}
					break;
				case 2 :
					// com/joestelmach/natty/generated/DateWalker.g:93:65: zone= ZONE_OFFSET
					{
	...
	// com/joestelmach/natty/generated/DateWalker.g:97:1: relative_time : ^( RELATIVE_TIME seek ) ;
	public final void relative_time() throws RecognitionException {
		try {
			// com/joestelmach/natty/generated/DateWalker.g:98:3: ( ^( RELATIVE_TIME seek ) )
			// com/joestelmach/natty/generated/DateWalker.g:98:5: ^( RELATIVE_TIME seek )
			{
	...
	// $ANTLR start "seek"
	// com/joestelmach/natty/generated/DateWalker.g:101:1: seek : ( ^( SEEK DIRECTION by= SEEK_BY amount= INT ^( DAY_OF_WEEK day= INT ) ( date )? ) | ^( SEEK DIRECTION SEEK_BY amount= INT ^( MONTH_OF_YEAR month= INT ) ) | ^( SEEK DIRECTION SEEK_BY ( explicit_seek | relative_date )? INT SPAN ) | ^( SEEK DIRECTION SEEK_BY INT date ) | ^( SEEK DIRECTION SEEK_BY INT HOLIDAY ) | ^( SEEK DIRECTION SEEK_BY INT SEASON ) );
	public final void seek() throws RecognitionException {
		...
		try {
			// com/joestelmach/natty/generated/DateWalker.g:102:3: ( ^( SEEK DIRECTION by= SEEK_BY amount= INT ^( DAY_OF_WEEK day= INT ) ( date )? ) | ^( SEEK DIRECTION SEEK_BY amount= INT ^( MONTH_OF_YEAR month= INT ) ) | ^( SEEK DIRECTION SEEK_BY ( explicit_seek | relative_date )? INT SPAN ) | ^( SEEK DIRECTION SEEK_BY INT date ) | ^( SEEK DIRECTION SEEK_BY INT HOLIDAY ) | ^( SEEK DIRECTION SEEK_BY INT SEASON ) )
			int alt18=6;
			...
			switch (alt18) {
				case 1 :
					// com/joestelmach/natty/generated/DateWalker.g:102:5: ^( SEEK DIRECTION by= SEEK_BY amount= INT ^( DAY_OF_WEEK day= INT ) ( date )? )
					{
					...
					// com/joestelmach/natty/generated/DateWalker.g:102:68: ( date )?
					int alt16=2;
					...
					break;
				case 2 :
					// com/joestelmach/natty/generated/DateWalker.g:105:5: ^( SEEK DIRECTION SEEK_BY amount= INT ^( MONTH_OF_YEAR month= INT ) )
					{
					...
					break;
				case 3 :
					// com/joestelmach/natty/generated/DateWalker.g:108:5: ^( SEEK DIRECTION SEEK_BY ( explicit_seek | relative_date )? INT SPAN )
					{
					...
					// com/joestelmach/natty/generated/DateWalker.g:108:30: ( explicit_seek | relative_date )?
					int alt17=3;
					...
					switch (alt17) {
						case 1 :
							// com/joestelmach/natty/generated/DateWalker.g:108:31: explicit_seek
							{
							...
							break;
						case 2 :
							// com/joestelmach/natty/generated/DateWalker.g:108:47: relative_date
							{
					...
					break;
				case 4 :
					// com/joestelmach/natty/generated/DateWalker.g:111:5: ^( SEEK DIRECTION SEEK_BY INT date )
					{
					...
					break;
				case 5 :
					// com/joestelmach/natty/generated/DateWalker.g:114:5: ^( SEEK DIRECTION SEEK_BY INT HOLIDAY )
					{
					...
					break;
				case 6 :
					// com/joestelmach/natty/generated/DateWalker.g:117:5: ^( SEEK DIRECTION SEEK_BY INT SEASON )
					{
	...
	// com/joestelmach/natty/generated/DateWalker.g:121:1: explicit_seek : ( ^( EXPLICIT_SEEK ^( MONTH_OF_YEAR day= INT ) ) | ^( EXPLICIT_SEEK ^( DAY_OF_MONTH month= INT ) ) | ^( EXPLICIT_SEEK ^( DAY_OF_WEEK day= INT ) ) | ^( EXPLICIT_SEEK ^( DAY_OF_YEAR day= INT ) ) | ^( EXPLICIT_SEEK ^( YEAR_OF year= INT ) ) | ^( EXPLICIT_SEEK HOLIDAY ^( YEAR_OF year= INT ) ) | ^( EXPLICIT_SEEK SEASON ^( YEAR_OF year= INT ) ) | ^( EXPLICIT_SEEK index= INT ^( DAY_OF_WEEK day= INT ) ) | ^( EXPLICIT_SEEK explicit_time ) );
	public final void explicit_seek() throws RecognitionException {
		...
		try {
			// com/joestelmach/natty/generated/DateWalker.g:122:3: ( ^( EXPLICIT_SEEK ^( MONTH_OF_YEAR day= INT ) ) | ^( EXPLICIT_SEEK ^( DAY_OF_MONTH month= INT ) ) | ^( EXPLICIT_SEEK ^( DAY_OF_WEEK day= INT ) ) | ^( EXPLICIT_SEEK ^( DAY_OF_YEAR day= INT ) ) | ^( EXPLICIT_SEEK ^( YEAR_OF year= INT ) ) | ^( EXPLICIT_SEEK HOLIDAY ^( YEAR_OF year= INT ) ) | ^( EXPLICIT_SEEK SEASON ^( YEAR_OF year= INT ) ) | ^( EXPLICIT_SEEK index= INT ^( DAY_OF_WEEK day= INT ) ) | ^( EXPLICIT_SEEK explicit_time ) )
			int alt19=9;
			...
			switch (alt19) {
				case 1 :
					// com/joestelmach/natty/generated/DateWalker.g:122:5: ^( EXPLICIT_SEEK ^( MONTH_OF_YEAR day= INT ) )
					{
					...
					break;
				case 2 :
					// com/joestelmach/natty/generated/DateWalker.g:125:5: ^( EXPLICIT_SEEK ^( DAY_OF_MONTH month= INT ) )
					{
					...
					break;
				case 3 :
					// com/joestelmach/natty/generated/DateWalker.g:128:5: ^( EXPLICIT_SEEK ^( DAY_OF_WEEK day= INT ) )
					{
					...
					break;
				case 4 :
					// com/joestelmach/natty/generated/DateWalker.g:131:5: ^( EXPLICIT_SEEK ^( DAY_OF_YEAR day= INT ) )
					{
					...
					break;
				case 5 :
					// com/joestelmach/natty/generated/DateWalker.g:134:5: ^( EXPLICIT_SEEK ^( YEAR_OF year= INT ) )
					{
					...
					break;
				case 6 :
					// com/joestelmach/natty/generated/DateWalker.g:137:5: ^( EXPLICIT_SEEK HOLIDAY ^( YEAR_OF year= INT ) )
					{
					...
					break;
				case 7 :
					// com/joestelmach/natty/generated/DateWalker.g:140:5: ^( EXPLICIT_SEEK SEASON ^( YEAR_OF year= INT ) )
					{
					...
					break;
				case 8 :
					// com/joestelmach/natty/generated/DateWalker.g:143:5: ^( EXPLICIT_SEEK index= INT ^( DAY_OF_WEEK day= INT ) )
					{
					...
					break;
				case 9 :
					// com/joestelmach/natty/generated/DateWalker.g:146:5: ^( EXPLICIT_SEEK explicit_time )
					{
