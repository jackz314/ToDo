// $ANTLR 3.5.2 com/joestelmach/natty/generated/TreeRewrite.g 2017-01-25 23:39:03
		...
		try {
			...
			switch (alt1) {
				case 1 :
					...
					// AST REWRITE
					// elements: INT, DAY_OF_WEEK, SEEK_BY, SEEK, DIRECTION, dow
					// token labels: dow
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 2 :
					...
					// AST REWRITE
					// elements: DIRECTION, dow, SEEK_BY, DAY_OF_MONTH, SEEK, INT
					// token labels: dow
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 3 :
					...
					// AST REWRITE
					// elements: DIRECTION, MONTH_OF_YEAR, SEEK_BY, SEEK, INT, dow
					// token labels: dow
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 4 :
					...
					// AST REWRITE
					// elements: MONTH_OF_YEAR, SEEK, dow, SEEK_BY, DIRECTION, amount
				...
				case 5 :
					...
					// AST REWRITE
					// elements: span, amt, SEEK_BY, DIRECTION, SEEK
				...
				case 6 :
					...
					// AST REWRITE
					// elements: RELATIVE_DATE, DAY_OF_WEEK, SEEK, MONTH_OF_YEAR, day, EXPLICIT_SEEK, year, month, dow, EXPLICIT_SEEK, dir, YEAR_OF, seekby, amount
